...
#define yyparse         fc45parse
#define yylex           fc45lex
#define yyerror         fc45error
#define yydebug         fc45debug
#define yynerrs         fc45nerrs
#define yylval          fc45lval
#define yychar          fc45char
...
#ifndef YY_FC45_FC45_TAB_H_INCLUDED
# define YY_FC45_FC45_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
#if YYDEBUG
extern int fc45debug;
#endif
...
#endif /* !YY_FC45_FC45_TAB_H_INCLUDED  */
...
{
  "$end", "error", "$undefined", "tInteger", "tString", "tIgnore",
  "tContinuous", "tDiscrete", "tEOF", "'.'", "','", "':'", "$accept",
  "ExampleSpec", "ClassList", "ClassSpec", "AttributeList",
  "AttributeSpec", "AttributeInfo", "AttributeValueNameList", YY_NULLPTR
};
#endif
...
{
      13,    14,    15,    16,     6,     7,     1,     5,    10,    12,
      19,    21,    20,    22,     0,     9
};

static const yytype_int8 yycheck[] =
{
       4,     5,     6,     7,     9,    10,     4,     0,     4,    11,
       4,    10,     9,     4,    -1,     7
};
...
{
       0,     4,    13,    14,    15,     0,     9,    10,    16,    15,
       4,    17,    11,     4,     5,     6,     7,    18,    19,     4,
       9,    10,     4
};
...
yyreduce:
  ...
  case 5:
#line 46 "core/fc45.y"
                   { ExampleSpecAddClass(exampleSpec, (yyvsp[0].string)); }
#line 1348 "fc45.tab.c"
    break;

  case 8:
#line 50 "core/fc45.y"
                                             { 
   AttributeSpecSetName(attributeSpec, (yyvsp[-3].string));
   ExampleSpecAddAttributeSpec(exampleSpec, attributeSpec);
   attributeSpec = AttributeSpecNew();
}
#line 1358 "fc45.tab.c"
    break;
...
#line 60 "core/fc45.y"
                   ...
                   AttributeSpecSetNumValues(attributeSpec, atoi((yyvsp[0].string))); }
#line 1380 "fc45.tab.c"
    break;
...
#line 66 "core/fc45.y"
   ...
   AttributeSpecAddValue(attributeSpec, (yyvsp[0].string)); }
#line 1396 "fc45.tab.c"
    break;
...
#line 70 "core/fc45.y"
   ...
   AttributeSpecSetNumValues(attributeSpec,
                     AttributeSpecGetNumValues(attributeSpec) + 1);
   AttributeSpecAddValue(attributeSpec, (yyvsp[0].string)); }
#line 1405 "fc45.tab.c"
    break;


#line 1409 "fc45.tab.c"
